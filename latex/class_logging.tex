...
\index{Logging@{Logging}!get\+Color@{get\+Color}}
\index{get\+Color@{get\+Color}!Logging@{Logging}}
...
\index{Logging@{Logging}!get\+Loglevel@{get\+Loglevel}}
\index{get\+Loglevel@{get\+Loglevel}!Logging@{Logging}}
\subsubsection{\texorpdfstring{get\+Loglevel()}{getLoglevel()}}
...
\index{Logging@{Logging}!set\+Log\+Color@{set\+Log\+Color}}
\index{set\+Log\+Color@{set\+Log\+Color}!Logging@{Logging}}
...
\index{Logging@{Logging}!set\+Loglevel@{set\+Loglevel}}
\index{set\+Loglevel@{set\+Loglevel}!Logging@{Logging}}
...
\index{Logging@{Logging}!set\+Print\+File\+Line@{set\+Print\+File\+Line}}
\index{set\+Print\+File\+Line@{set\+Print\+File\+Line}!Logging@{Logging}}
