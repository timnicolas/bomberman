...
\mbox{\hyperlink{class_bonus}{Bonus}} object.  
...
\begin{DoxyCompactList}\small\item\em \mbox{\hyperlink{class_bonus}{Bonus}} Exception. \end{DoxyCompactList}\end{DoxyCompactItemize}
\doxysubsection*{Public Member Functions}
\begin{DoxyCompactItemize}
\item 
\mbox{\hyperlink{class_bonus_a35c21e394ed7467d9bf1038cffc77047}{Bonus}} (\mbox{\hyperlink{class_scene_game}{Scene\+Game}} \&\mbox{\hyperlink{class_a_entity_aa2c05db944a8b7487eb8470dd20211ab}{game}})
\begin{DoxyCompactList}\small\item\em Construct a new \mbox{\hyperlink{class_bonus}{Bonus}}\+:\+: \mbox{\hyperlink{class_bonus}{Bonus}} object. \end{DoxyCompactList}\item 
\mbox{\hyperlink{class_bonus_ace96cd91925b1f65b2c8596930fed6f5}{$\sim$\+Bonus}} ()
\begin{DoxyCompactList}\small\item\em Destroy the \mbox{\hyperlink{class_bonus}{Bonus}}\+:\+: \mbox{\hyperlink{class_bonus}{Bonus}} object. \end{DoxyCompactList}\item 
\mbox{\hyperlink{class_bonus_aedadb1a74a12d5c42f7dc26db1823ebd}{Bonus}} (\mbox{\hyperlink{class_bonus}{Bonus}} const \&src)
\begin{DoxyCompactList}\small\item\em Construct a new \mbox{\hyperlink{class_bonus}{Bonus}}\+:\+: \mbox{\hyperlink{class_bonus}{Bonus}} object. \end{DoxyCompactList}\item 
\mbox{\hyperlink{class_bonus}{Bonus}} \& \mbox{\hyperlink{class_bonus_a739b5ec5b1e7214fd0398e4a7970529e}{operator=}} (\mbox{\hyperlink{class_bonus}{Bonus}} const \&rhs)
\begin{DoxyCompactList}\small\item\em Copy this object. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{class_bonus_a976414b70e76b18dadeae3f316a22547}{init}} ()
\begin{DoxyCompactList}\small\item\em Init \mbox{\hyperlink{class_bonus}{Bonus}}. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactItemize}
\item 
static std\+::unordered\+\_\+map$<$ std\+::string, Bonus\+Type\+::\+Enum $>$ \mbox{\hyperlink{class_bonus_a6738b5cd2f41a4174a721bc51f495ea9}{bonus}}
\item 
static std\+::unordered\+\_\+map$<$ Bonus\+Type\+::\+Enum, std\+::string $>$ \mbox{\hyperlink{class_bonus_a49a478d9b31b6d9bf2daf5d27af7ef9c}{description}}
\item 
static std\+::unordered\+\_\+map$<$ Bonus\+Type\+::\+Enum, std\+::string $>$ \mbox{\hyperlink{class_bonus_a87700fdcb79541aa990d15927da2c905}{bonus\+Textures}}
...
{\footnotesize\ttfamily Bonus\+::\+Bonus (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{class_scene_game}{Scene\+Game}} \&}]{game }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [explicit]}}



Construct a new \mbox{\hyperlink{class_bonus}{Bonus}}\+:\+: \mbox{\hyperlink{class_bonus}{Bonus}} object. 
...
Destroy the \mbox{\hyperlink{class_bonus}{Bonus}}\+:\+: \mbox{\hyperlink{class_bonus}{Bonus}} object. 
...
{\footnotesize\ttfamily Bonus\+::\+Bonus (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{class_bonus}{Bonus}} const \&}]{src }\end{DoxyParamCaption})}
...
Init \mbox{\hyperlink{class_bonus}{Bonus}}. 
...
{\footnotesize\ttfamily \mbox{\hyperlink{class_bonus}{Bonus}} \& Bonus\+::operator= (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{class_bonus}{Bonus}} const \&}]{rhs }\end{DoxyParamCaption})}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
\mbox{\hyperlink{class_bonus}{Bonus}}\& A reference to the copied object 
\end{DoxyReturn}
...
\end{DoxyCode}
All bonus (link btw str \& enum) \mbox{\Hypertarget{class_bonus_a87700fdcb79541aa990d15927da2c905}\label{class_bonus_a87700fdcb79541aa990d15927da2c905}} 
\index{Bonus@{Bonus}!bonusTextures@{bonusTextures}}
\index{bonusTextures@{bonusTextures}!Bonus@{Bonus}}
\doxysubsubsection{\texorpdfstring{bonusTextures}{bonusTextures}}
{\footnotesize\ttfamily std\+::unordered\+\_\+map$<$ Bonus\+Type\+::\+Enum, std\+::string $>$ Bonus\+::bonus\+Textures\hspace{0.3cm}{\ttfamily [static]}}

{\bfseries Initial value\+:}
\begin{DoxyCode}{0}
\DoxyCodeLine{= \{}
\DoxyCodeLine{    \{ BonusType::LIFE, \textcolor{stringliteral}{"bomberman-\/assets/3dModels/bonus/textures/life.png"} \},}
\DoxyCodeLine{    \{ BonusType::BOMBS, \textcolor{stringliteral}{"bomberman-\/assets/3dModels/bonus/textures/bomb.png"} \},}
\DoxyCodeLine{    \{ BonusType::FLAMES, \textcolor{stringliteral}{"bomberman-\/assets/3dModels/bonus/textures/flamme.png"} \},}
\DoxyCodeLine{    \{ BonusType::SPEED, \textcolor{stringliteral}{"bomberman-\/assets/3dModels/bonus/textures/speed.png"} \},}
\DoxyCodeLine{    \{ BonusType::WALLPASS, \textcolor{stringliteral}{"bomberman-\/assets/3dModels/bonus/textures/wallpass.png"} \},}
\DoxyCodeLine{    \{ BonusType::DETONATOR, \textcolor{stringliteral}{"bomberman-\/assets/3dModels/bonus/textures/detonator.png"} \},}
\DoxyCodeLine{    \{ BonusType::BOMBPASS, \textcolor{stringliteral}{"bomberman-\/assets/3dModels/bonus/textures/bombpass.png"} \},}
\DoxyCodeLine{    \{ BonusType::FLAMPASS, \textcolor{stringliteral}{"bomberman-\/assets/3dModels/bonus/textures/flampass.png"} \},}
\DoxyCodeLine{    \{ BonusType::SHIELD, \textcolor{stringliteral}{"bomberman-\/assets/3dModels/bonus/textures/shield.png"} \},}
\DoxyCodeLine{    \{ BonusType::TIME, \textcolor{stringliteral}{"bomberman-\/assets/3dModels/bonus/textures/time.png"} \},}
\DoxyCodeLine{    \{ BonusType::POINTS, \textcolor{stringliteral}{"bomberman-\/assets/3dModels/bonus/textures/score.png"} \},}
\DoxyCodeLine{\}}

\end{DoxyCode}
All bonus textures \mbox{\Hypertarget{class_bonus_a49a478d9b31b6d9bf2daf5d27af7ef9c}\label{class_bonus_a49a478d9b31b6d9bf2daf5d27af7ef9c}} 
...
{\footnotesize\ttfamily std\+::unordered\+\_\+map$<$ Bonus\+Type\+::\+Enum, std\+::string $>$ Bonus\+::description\hspace{0.3cm}{\ttfamily [static]}}
