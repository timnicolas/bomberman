...
\index{Spawner@{Spawner}!add\+Type\+Enemy@{add\+Type\+Enemy}}
\index{add\+Type\+Enemy@{add\+Type\+Enemy}!Spawner@{Spawner}}
...
\index{Spawner@{Spawner}!post\+Update@{post\+Update}}
\index{post\+Update@{post\+Update}!Spawner@{Spawner}}
...
\index{Spawner@{Spawner}!set\+Frequency@{set\+Frequency}}
\index{set\+Frequency@{set\+Frequency}!Spawner@{Spawner}}
...
\index{Spawner@{Spawner}!set\+Type\+Enemy@{set\+Type\+Enemy}}
\index{set\+Type\+Enemy@{set\+Type\+Enemy}!Spawner@{Spawner}}
